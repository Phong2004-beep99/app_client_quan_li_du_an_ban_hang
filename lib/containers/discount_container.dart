...
import 'package:app_client_2/models/coupon_model.dart';
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                ...
                ,children: [
                Text("Sử dụng mã giảm giá: ${discounts[0].code}",style:  TextStyle(fontSize: 18,fontWeight: FontWeight.w500,color: Colors.blue.shade900)),
